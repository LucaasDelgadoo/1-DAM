...
import javax.swing.JOptionPane;
	...
	/**
	 * Clase ejecutable (Main), que representa la creacion del programa completo usando las clases Circuito, PilotoKart, Competicion
...
public class Main {
	...
	/**
	 * Método empleado para la creacion de una nueva competicion.
	 * 
	 * Se genera la creacion de un circuito con sus parametros usando su constructor principal,
	 * Los pilotos que participaran en la competicion junto con sus parametros usando su constructor principal.
	 * Dependiendo de el nombre de la competicion creada en el main retornara el (return) una competicion u otra.
	 * 
	 * @param nombreCompeticion
	 * @return Un objeto de la clase Competicion, que es una competicion con los pilotos y el circuito que la componen
	 */
	...
	/**
	 * Metodo que permite poder visualizar los pilotos de la competicion y la posibilidad de seleccionarlo.
	 * Poder seleccionar la opcion "anterior", "siguiente", "seleccionar el piloto".
	 * 
	 * @param competicion
	 */
	...
	/**
	 * Metodo que muestra la ventana de la competicion.
	 * 
	 * Este método tiene una cadena con la información detallada de la competicion,
     * incluyendo el nombre de la competicion, junto con sus caracteristicas y su imagen.
     * 
	 * @param competicion
	 */
	...
	/**
	 * Metodo que muestra una ventana donde se ve la informacion del piloto junto con la imagen
	 * 
	 * @param kart
	 * @return Boton que es pulsado
	 */
